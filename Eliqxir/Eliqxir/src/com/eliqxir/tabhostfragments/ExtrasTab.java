...
public class ExtrasTab extends Fragment {
    /** (non-Javadoc)
...
//	HashMap<String, String> hashMapKeys = new HashMap<String, String>();
	...
	String subCategoryId, subCategoryName, subCategoryDesc, subCategoryPrice,feature_status,stock_values,fioz_value,
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.tab_mixers, container, false);
        pager = (ViewPager) v
      ...
      /*  vendorSharedpreferences = getActivity().getSharedPreferences("vendorPrefs", Context.MODE_PRIVATE);
        ...
        Log.e("stordID in extras tab",stordID);*/
 ...
 //       customerPrefEditor=customerPreference.edit();
		...
		Log.e("stordID inside extras tab &&&&&&&&&&&&", stordID);
...
String status="notAvailable",error;
			...
			protected Boolean doInBackground(Void... params) {
				...
				if(menuPref==null)
				{
					...
					Log.e("Extras Customer Browse Response",""+jsonObj);
				}
						...
						if (status.equals("1")) {
							...
							for (int k = 0; k < subCategoryArray.length(); k++) {
								...
								for (int l = 0; l < catList.size(); l++) {
									...
									Log.e("Split[0] in Extras Tab",split[0]);
									if (split[0].equals("Mixers")) {
							...
							for (int i = 0; i < subcatList.size(); i++) {
								...
								for (int j = 0; j < jsonArray1.length(); j++) {
									...
									if (job2.getString("parent_category")
											.equals("Mixers")&& category.equals(subcatList
													.get(i))) {
									...
									//	String parentId=job2.getString("id");
										...
										//Added on April 22nd, 27th and 28th
			...
			protected void onPostExecute(Boolean result) {
				...
				if (subCategoriesHeader.size() > 0) {
					...
					txtNoItem.setText("No Products available for Extras.");
