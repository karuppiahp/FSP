...
import activities.mswift.info.walaapp.wala.asyntasks.ConfirmOTPLoginTask;
...
/**
 * Created by karuppiah on 9/22/2016.
 */
public class OTPLoginActivity extends Activity implements View.OnClickListener {
    ...
    public void apiCall() {
        ...
        new ConfirmOTPLoginTask(this, token, progressBar, params);
    }
