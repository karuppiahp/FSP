...
public class UseInitialValue {
    ...
    public UseInitialValue(Context context, Map<String, String> params, FragmentManager fragmentManager, String savingsTypeBackend, String amount) {
