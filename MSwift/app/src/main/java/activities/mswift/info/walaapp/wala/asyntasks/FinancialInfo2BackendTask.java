 ...
 */
public class FinancialInfo2BackendTask {
    private Context context;
    private JSONObject jObject = null;
    private Map<String, String> params;
    private String authorizationKey, result = "", status = "", message = "";

    public FinancialInfo2BackendTask(Context context, Map<String, String> params) {
    ...
    public void ResponseTask() {
        ...
        new ServerResponse(ApiClass.getBackendApiUrl(Constants.INCOMEUPDATE_BACK)).getJSONObjectfromURL(ServerResponse.RequestType.POST, params, authorizationKey, context, SessionStores.getInstallationId(context), new VolleyResponseListener() {
            @Override
