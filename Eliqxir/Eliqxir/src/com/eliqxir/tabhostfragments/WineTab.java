...
public class WineTab extends Fragment {
    /** (non-Javadoc)
...
//	HashMap<String, String> hashMapKeys = new HashMap<String, String>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.tab_wine, container, false);
        pager = (ViewPager) v
 ...
 //       customerPrefEditor=customerPreference.edit();
        ...
        Log.e("stordID inside Wine Tab $$$$$$$$$$4",stordID);
...
String status="notAvailable",error;
				...
				if(menuPref==null)
				{
					...
					jsonObj = new ServerResponse(
							...
							.getJSONObjectfromURL(RequestType.POST,
									nameValuepair);
					Log.e("Wine Customer Browse Response",""+jsonObj);
						...
						if (status.equals("1")) {
							...
							for (int k = 0; k < subCategoryArray.length(); k++) {
								...
								for (int l = 0; l < catList.size(); l++) {
							     ...
							     Log.e("Split[0] in wine Tab",split[0]);
									if (split[0].equals("Wine")) {
							...
							for (int i = 0; i < subcatList.size(); i++) {
								...
								for (int j = 0; j < jsonArray1.length(); j++) {
									...
									if (job2.getString("parent_category")
											.equals("Wine")&& category.equals(subcatList
													.get(i))) {
			...
			protected void onPostExecute(Boolean result) {
				...
				if (subCategoriesHeader.size() > 0) {
					...
					txtNoItem.setText("No Products available for Wine.");
