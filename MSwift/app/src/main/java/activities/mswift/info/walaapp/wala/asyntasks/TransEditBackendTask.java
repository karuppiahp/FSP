...
/**
 * Created by karuppiah on 4/20/2016.
 */
public class TransEditBackendTask {
    private Context context;
    private JSONObject jObject = null;
    private Map<String, String> params;
    private String authorizationKey, result = "", status = "", message = "";

    public TransEditBackendTask(Context context, Map<String, String> params) {
    ...
    public void ResponseTask() {
        ...
        new ServerResponse(ApiClass.getBackendApiUrl(Constants.EDITTRANS_BACK)).getJSONObjectfromURL(ServerResponse.RequestType.POST, params, authorizationKey, context, SessionStores.getInstallationId(context), new VolleyResponseListener() {
            @Override
