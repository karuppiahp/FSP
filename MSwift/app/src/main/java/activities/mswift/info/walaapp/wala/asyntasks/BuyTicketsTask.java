...
public class BuyTicketsTask {
    ...
    public BuyTicketsTask(Context context, Map<String, String> params) {
    ...
    public void ResponseTask() {
        new ServerResponse(ApiClass.getBackendApiUrl(Constants.BUY_TICKET)).getJSONObjectfromURL(ServerResponse.RequestType.POST, params, Constants.BEARER_KEY, context, "", new VolleyResponseListener() {
            @Override
            public void onError(String message) {
                GamesActivity.btnForBuyTicket.setClickable(true);
                GamesActivity.btnForBuyTicket.setEnabled(true);
