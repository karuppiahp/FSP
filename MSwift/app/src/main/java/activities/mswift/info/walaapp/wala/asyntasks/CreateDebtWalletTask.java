...
/**
 * Created by kruno on 10.03.16..
 */
public class CreateDebtWalletTask {
    private Activity context;
    private String authorizationKey;

    public CreateDebtWalletTask(Activity context) {
        this.context = context;

        createDebtWallet();
    }

    public void createDebtWallet() {
        JSONObject request = getJsonWalletName("debt");
                    ...
                    public void onResponse(JSONObject response) {
                        if (response.has("DataObject")) {
                            ...
                            try {
                                ...
                                String debtWalletCode = jsonObject1.getString("WalletCode");
                                SessionStores.saveDebtWalletNumber(debtWalletCode, context);
