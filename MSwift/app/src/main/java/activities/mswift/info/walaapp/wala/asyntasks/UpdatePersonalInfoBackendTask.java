 ...
 */
public class UpdatePersonalInfoBackendTask {
    ...
    public UpdatePersonalInfoBackendTask(Context context, Map<String, String> params, FragmentManager fragmentManager) {
    ...
    public void ResponseTask() {
        ...
        new ServerResponse(ApiClass.getBackendApiUrl(Constants.UPDATEUSER_BACK)).getJSONObjectfromURL(ServerResponse.RequestType.POST, params, authorizationKey, context, SessionStores.getInstallationId(context), new VolleyResponseListener() {
            @Override
