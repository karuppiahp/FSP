...
/**
 * Created by karuppiah on 4/18/2016.
 */
public class FinancialInfo4BackendTask {
    private Context context;
    private JSONObject jObject = null;
    private Map<String, String> params;
    private String authorizationKey, result = "", status = "", message = "";

    public FinancialInfo4BackendTask(Context context, Map<String, String> params) {
    ...
    public void ResponseTask() {
        ...
        new ServerResponse(ApiClass.getBackendApiUrl(Constants.ADDDEPT_BACK)).getJSONObjectfromURL(ServerResponse.RequestType.POST, params, authorizationKey, context, SessionStores.getInstallationId(context), new VolleyResponseListener() {
            @Override
