...
public class PayOffLoan {
    ...
    public PayOffLoan(Context context, Map<String, String> params, FragmentManager fragmentManager, Map<String, String> params1, int arrayNumber) {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (jObject != null) {
                        if (jObject.has("Status")) {
                            ((TabHostFragments) context).progressBarGone();
                            debtBalance = jObject.getString("Status");
                            message = jObject.getString("Message");

                            if (debtBalance.equals("000000")) {
                                ResponseTask();
                            } else {
                                Toast.makeText(context, "" + "You can not create transaction because your Dept balance is less than entered amount.", Toast.LENGTH_LONG).show();
                            }
