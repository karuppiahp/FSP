...
import com.facebook.widget.ConnectFacebook.LoginButtonCallback;
import com.facebook.widget.LoginButton.LoginButtonProperties;
import com.facebook.widget.ConnectFacebook.LoginClickListener;
import com.facebook.widget.LoginButton.OnErrorListener;
import com.facebook.widget.LoginButton.ToolTipMode;
import com.facebook.widget.LoginButton.UserInfoChangedCallback;

public class ConnectFacebook extends Button {
     ...
     */
    public ConnectFacebook(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        if (attrs.getStyleAttribute() == 0) {
          ...
          //      this.setBackgroundColor(getResources().getColor(R.color.com_facebook_blue));
            	this.setBackgroundResource(R.drawable.settings_fb_btn);
                // hardcoding in edit mode as getResources().getString() doesn't seem to work in IntelliJ
                loginText = "Connect with Facebook";
            } else {
                this.setBackgroundResource(R.drawable.settings_fb_btn);
                /*this.setCompoundDrawablesWithIntrinsicBounds(R.drawable.register_btn_fb, 0, 0, 0);
     ...
     */
    public ConnectFacebook(Context context, AttributeSet attrs, int defStyle) {
