...
public class IncomeTypeAdapter extends BaseAdapter {
    ...
    public IncomeTypeAdapter(Context context, ArrayList<IncomeTypeModel> incomeTypeArray) {
        this.context = context;
        this.incomeTypeArray = incomeTypeArray;
    }

    @Override
    public int getCount() {
        return incomeTypeArray.size();
    }
    ...
    public View getView(int i, View v, ViewGroup viewGroup) {
        ...
        IncomeTypeModel incomeTypeModel = incomeTypeArray.get(i);
        textView.setText(incomeTypeModel.getType());
        return v;
    }
}